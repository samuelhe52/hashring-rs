...
The existing receipt-layout and completed-ACK cleanup measurements are documented separately in [receipt store memory](dedup-receipt-store-memory.md).
